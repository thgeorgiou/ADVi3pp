...
#define HEATER_0_MAXTEMP 300 // @advi3++
 ...
 */
#ifdef DEBUG
// @advi3++: Enable leveling debugging for DEBUG builds
...
//
// Wanhao Duplicator i3+ LCD
// Mini DGUS DMT48270M043_05WT or DMT48270M043_02WT
//
// @advi3++: Enable i3 Plus LCD support and it has a (passive) buzzer
#define I3PLUS_LCD
...
// @advi3++: Use software PWM for the fan to fix bug #107 (interraction between BLTouch and the fan)
#define FAN_SOFT_PWM
